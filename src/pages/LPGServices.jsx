...
export default function LPGServices() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-muted text-foreground py-10 pt-[140px]">
        <div className="mx-auto my-1 px-3 max-w-7xl">
          <h1 className="mb-4 pt-10 pb-3 text-3xl font-semibold md:text-5xl">LPG & Gas Services</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <ul className="space-y-3 mb-8">
                {["Certified LPG refilling stations", "Bulk LPG supply for industries", "Residential & commercial solutions", "Safety-trained attendants", "Competitive pricing nationwide"].map((item, i) => (
              ...
              <Link to="/Stations">
                <button className="bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors flex items-center gap-2">
                  <Flame className="w-4 h-4" /> Find LPG Stations
                </button>
              </Link>
            </motion.div>
