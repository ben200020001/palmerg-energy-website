...
/**
 * Site media for Palmerg Energy
 *
 * 1) Edit `src/data/siteMedia.overrides.json`: set any value to a full CDN URL.
 *    Leave "" to keep the default (local `public/` or bundled `src/assets`).
 *
 * 2) Optional — merge more URLs from environment without editing JSON:
